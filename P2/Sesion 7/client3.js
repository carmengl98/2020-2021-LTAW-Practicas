...
boton_ajax.onclick = () => {
    ...
    m.onreadystatechange = () => {
        ...
        if (m.readyState==4) {
            ...
            if (m.status==200) {
                ...
                //objeto que se llama productos
                //parse convierte  de una cadena de texto a JSON
    ...
    //-- Configurar la petición con parámetros
    m.open("GET","/productos?param1=hola&param2=wei", true); // Siempre asincrona(true??)
